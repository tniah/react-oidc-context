## API Report File for "react-oidc-client-lib"

> Do not edit this file. It is a report generated by [API Extractor](https://api-extractor.com/).

```ts

import type { QuerySessionStatusArgs } from 'oidc-client-lib';
import { default as React_2 } from 'react';
import type { RevokeTokensTypes } from 'oidc-client-lib';
import type { SessionStatus } from 'oidc-client-lib';
import type { SigninPopupArgs } from 'oidc-client-lib';
import type { SigninRedirectArgs } from 'oidc-client-lib';
import type { SigninResourceOwnerCredentialsArgs } from 'oidc-client-lib';
import type { SigninSilentArgs } from 'oidc-client-lib';
import type { SignoutPopupArgs } from 'oidc-client-lib';
import type { SignoutRedirectArgs } from 'oidc-client-lib';
import type { SignoutResponse } from 'oidc-client-lib';
import type { SignoutSilentArgs } from 'oidc-client-lib';
import { User } from 'oidc-client-lib';
import { UserManager } from 'oidc-client-lib';
import type { UserManagerEvents } from 'oidc-client-lib';
import { UserManagerSettings } from 'oidc-client-lib';
